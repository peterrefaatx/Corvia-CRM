  ...
  const loadLeads = async () => {
    try {
      ...
      const deadLeads = response.data
        .filter((lead: any) => {
          if (lead.pipelineStage !== 'Dead') return false;
      ...
      <div className="min-h-screen" style={{ backgroundColor: '#fafafa' }}>
        <div className="w-full px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="bg-white rounded-2xl p-6 border border-gray-100 mb-6">
            {/* Title */}
            <div className="mb-5">
              <h1 className="text-2xl font-semibold text-gray-900">Dead Leads</h1>
            </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden">
            ...
            {filteredLeads.length === 0 && (
              <div className="text-center py-12 text-gray-500">
                <p className="text-lg font-medium">No dead leads</p>
                <p className="text-sm mt-2">Dead leads will appear here</p>
              </div>
            )}
          </div>
        </div>
