...
const MyITTickets: React.FC = () => {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case 'UnderReview': return 'bg-cyan-100 text-cyan-800 border border-cyan-200';
      ...
      <div className="py-8 px-4 sm:px-6 lg:px-8" style={{ backgroundColor: '#f7f6f5' }}>
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-3">
              ...
              <input
                ...
                className="px-3 py-2 border border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm"
              />
              {selectedDate !== 'today' && (
                <button
            ...
            <button
              ...
              className="bg-primary bg-primary-hover text-white px-6 py-3 text-sm font-medium shadow-sm transition-colors"
            >
              + New Ticket
            </button>
          </div>
        ...
        <div className="grid grid-cols-5 gap-4 mb-6">
          ...
          <div
            ...
            className={`cursor-pointer glass border border-neutral-200/30 p-4 shadow-sm transition-all ${
              statusFilter === 'UnderReview' ? 'ring-2 ring-blue-500' : ''
            }`}
          >
          ...
          <div
            ...
            className={`cursor-pointer glass border border-neutral-200/30 p-4 shadow-sm transition-all ${
              statusFilter === 'Solved' ? 'ring-2 ring-blue-500' : ''
            }`}
          >
          ...
          <div
            ...
            className={`cursor-pointer glass border border-neutral-200/30 p-4 shadow-sm transition-all ${
              statusFilter === 'NotSolved' ? 'ring-2 ring-blue-500' : ''
            }`}
          >
                ...
                <div key={ticket.id} className="p-6 hover:bg-white/50 transition-colors">
                  <div className="flex items-start justify-between">
                    ...
                    <button
                      ...
                      className="ml-4 inline-flex items-center px-3 py-1.5 bg-primary text-white bg-primary-hover text-xs font-medium shadow-sm transition-colors"
                    >
                      View Details
                    </button>
                  </div>
