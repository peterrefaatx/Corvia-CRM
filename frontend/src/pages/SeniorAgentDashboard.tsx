...
const SeniorAgentDashboard: React.FC = () => {
  ...
  // Redirect non-senior agents
  useEffect(() => {
    if (user?.role !== 'SeniorAgent') {
      navigate('/');
    }
  }, [user, navigate]);
            ...
            <div className="p-8 h-full" style={{ backgroundColor: '#F4F6FA', border: '1px solid #E5E7EB', borderLeft: '4px solid #D1D5DB', borderRadius: '0' }}>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 h-full items-center">
                ...
                <div className="text-center border-l border-r border-gray-200">
                  ...
                  <p className="text-xl font-extrabold bg-gradient-to-r from-cyan-600 to-blue-600 bg-clip-text text-transparent">
...
export default SeniorAgentDashboard;
