    ...
    <Layout>
      ...
      <div className="mb-8 grid grid-cols-1 lg:grid-cols-6 gap-6 items-stretch">
        ...
        <div className="lg:col-span-5">
          <div className="p-8 h-full" style={{ backgroundColor: '#F4F6FA', border: '1px solid #E5E7EB', borderLeft: '4px solid #D1D5DB', borderRadius: '0' }}>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 h-full items-center">
              <div className="text-center">
                <p className="text-sm font-bold text-gray-500 uppercase tracking-widest mb-4">Team Leader</p>
              ...
              <div className="text-center">
                <p className="text-sm font-bold text-gray-500 uppercase tracking-widest mb-4">Team</p>
                <p className="text-2xl font-extrabold text-cyan-600">{user?.team?.name || 'Not Assigned'}</p>
              </div>
              
              <div className="text-center">
                <p className="text-sm font-bold text-gray-500 uppercase tracking-widest mb-4">Role</p>
                <p className="text-2xl font-extrabold bg-gradient-to-r from-slate-800 to-slate-600 bg-clip-text text-transparent">
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-6 relative">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mt-4">
            ...
            <div className="text-center p-4 bg-cyan-50 rounded-lg">
              ...
              <p className="text-3xl font-bold text-cyan-600">{qualityMetrics.activeCampaigns}</p>
            </div>
            <div className="text-center p-4 bg-cyan-50 rounded-lg">
              <p className="text-sm text-gray-600 mb-1">Active Agents</p>
              <p className="text-3xl font-bold text-cyan-600">{qualityMetrics.activeAgents}</p>
            </div>
          </div>
        </div>
      )}
          ...
          {recentActivity.slice(0, 4).map((activity) => (
            ...
            >
              ...
              <span className={`px-2 py-1 rounded-full text-xs font-semibold border ${
                activity.status === 'Qualified' ? 'bg-green-100 text-green-800 border-green-200' :
                activity.status === 'Disqualified' ? 'bg-red-100 text-red-800 border-red-200' :
