        ...
        <div className="glass border border-neutral-200/30 shadow-sm p-6 mb-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 border border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm"
          ...
          <div className="flex gap-3">
            <button
              ...
              disabled={loading}
              className="px-4 py-2 bg-primary text-white bg-primary-hover transition-colors text-sm font-medium shadow-sm flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
            >
          ...
          {message && (
            <div className={`mt-4 p-4 shadow-sm flex items-center gap-2 ${
              results.length > 0 ? 'bg-primary-light border border-blue-200 text-blue-800' : 'bg-yellow-50 border border-yellow-200 text-yellow-800'
            }`}>
                      ...
                      <tr key={lead.id} className="hover:bg-white/50 transition-colors border-b border-gray-200">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-center">
                          <button
                            ...
                            className="inline-flex items-center px-3 py-1.5 bg-primary text-white bg-primary-hover text-xs font-medium shadow-sm transition-colors"
                          >
                            View Details
                          </button>
                        </td>
