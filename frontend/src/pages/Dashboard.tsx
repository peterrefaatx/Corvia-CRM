...
const Dashboard: React.FC = () => {
  ...
  const StatCard: React.FC<{ 
    ...
    return (
      <div 
        className="bg-white p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-200"
      >
        <div className="flex flex-col items-center justify-center h-full text-center space-y-3">
          <p className="text-sm uppercase tracking-widest font-bold text-gray-400">
            {title}
          </p>
          <p className="text-5xl font-extrabold leading-none" style={{ color, letterSpacing: '-0.04em' }}>
            {value}
          </p>
          {description && (
      ...
      <div className="py-8 px-4 sm:px-6 lg:px-8" style={{ backgroundColor: '#f7f6f5' }}>
          ...
          <div className={user && user.role !== 'Manager' && user.role !== 'Client' ? 'lg:col-span-5' : 'lg:col-span-6'}>
            <div className="p-8 h-full" style={{ backgroundColor: '#F4F6FA', border: '1px solid #E5E7EB', borderLeft: '4px solid #D1D5DB', borderRadius: '0' }}>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 h-full items-center">
                <div className="text-center">
                  <p className="text-sm uppercase tracking-widest mb-4 font-bold" style={{ color: '#6b7280' }}>
                    Agent
                  </p>
                  <p className="text-2xl bg-gradient-to-r from-slate-800 to-slate-600 bg-clip-text text-transparent font-extrabold">
                ...
                <div className="text-center border-l border-r border-gray-200">
                  ...
                  <p className="text-xl bg-gradient-to-r from-cyan-600 to-blue-600 bg-clip-text text-transparent font-extrabold">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-6 gap-6 mb-8">
          ...
          {monthStats && dashboardSettings?.targetLevels && (
            <div className="lg:col-span-1">
              <div className="bg-white h-full flex flex-col shadow-sm border border-gray-100">
                {/* Progress Section */}
                <div className="flex-1 px-8 py-5 flex items-center gap-6">
                  ...
                  <div className="relative" style={{ width: '12px' }}>
                    ...
                    <div className="w-full h-full bg-gray-200 relative" style={{ minHeight: '240px' }}>
