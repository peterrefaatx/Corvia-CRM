      ...
      <div className="py-8 px-4 sm:px-6 lg:px-8" style={{ backgroundColor: '#f7f6f5' }}>
        ...
        <div className="mb-8 grid grid-cols-1 lg:grid-cols-6 gap-6 items-stretch">
          ...
          <div className="lg:col-span-1">
            <div className="p-6 h-full flex flex-col justify-center shadow-sm" style={{ backgroundColor: '#F4F6FA', border: '1px solid #E5E7EB', borderLeft: '4px solid #D1D5DB', borderRadius: '0' }}>
          ...
          <div className="lg:col-span-5">
            <div className="p-8 h-full shadow-sm flex items-center justify-center" style={{ backgroundColor: '#F4F6FA', border: '1px solid #E5E7EB', borderLeft: '4px solid #D1D5DB', borderRadius: '0' }}>
              <div className="text-center">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-5 mb-8">
          ...
          <div className="bg-white p-6 shadow-sm border border-gray-100">
            <div className="text-center">
              ...
              <p className="text-4xl font-bold mb-1 tracking-tight text-cyan-600">{stats.underReview}</p>
            </div>
          </div>
          <div className="bg-white p-6 shadow-sm border border-gray-100">
            <div className="text-center">
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="text-4xl font-bold text-cyan-600 mb-1">{stats.solved + stats.notSolved}</div>
