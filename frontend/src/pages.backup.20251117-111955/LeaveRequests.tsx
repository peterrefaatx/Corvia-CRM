          ...
          <div className="flex justify-end items-center">
            {user?.role !== 'Manager' && (
              <button
                ...
                className="px-6 py-3 text-sm font-medium text-white bg-cyan-600 hover:bg-cyan-700 rounded-lg transition-colors"
              >
                + New Request
              </button>
            )}
                ...
                <form onSubmit={handleCreateRequest} className="space-y-4">
                  <div>
                    ...
                    <select
                      ...
                      className="block w-full px-3 py-2 border border-gray-300 shadow-sm focus:border-cyan-500 focus:ring-cyan-500 text-sm"
                      required
                    >
                  ...
                  <div className="flex justify-end space-x-3 pt-4">
                    ...
                    <button
                      ...
                      className="px-4 py-2 text-sm font-medium text-white bg-cyan-600 hover:bg-cyan-700 shadow-sm disabled:opacity-50 transition-colors"
                    >
