    ...
    return (
      <Layout>
        <div className="flex items-center justify-center h-64">
          <div className="animate-spin rounded-full h-12 w-12 border-2 border-mint-300 border-t-mint-500"></div>
        </div>
      </Layout>
    );
  }
                ...
                <tr key={team.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <button
                      ...
                      className="inline-flex items-center px-3 py-1.5 bg-blue-100 text-blue-800 hover:bg-blue-200 rounded text-xs font-medium mr-2"
                    >
                      View Members
                    </button>
                    <button
                    ...
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold ${
                          member.role === 'TeamLeader' ? 'bg-blue-100/80 text-blue-700 border border-blue-200/50' :
                          member.role === 'SeniorAgent' ? 'bg-purple-100/80 text-purple-700 border border-purple-200/50' :
              ...
              <div className="text-center">
                ...
                <div className="mt-2">
                  ...
                  {(selectedTeam._count && (selectedTeam._count.users > 0 || selectedTeam._count.leads > 0)) && (
                    <div className="mt-4 mb-4 p-4 glass rounded-xl border border-blue-200/50 shadow-subtle">
                      <p className="text-sm text-blue-700 font-medium mb-2" style={{ letterSpacing: '0.01em' }}>
                        📊 This team has:
                      </p>
                      <ul className="text-xs text-blue-600 mt-1 list-disc list-inside space-y-1" style={{ letterSpacing: '0.01em' }}>
                      ...
                      <p className="text-xs text-blue-600 mt-3" style={{ letterSpacing: '0.01em' }}>
