  ...
  const loadLeads = async () => {
    try {
      ...
      const closedLeads = response.data
        .filter((lead: any) => lead.pipelineStage === 'Closed')
        .map((lead: any) => ({
          id: lead.id,
      ...
      <div className="min-h-screen" style={{ backgroundColor: '#f7f6f5' }}>
        ...
        <div className="bg-white border-b border-slate-100 px-8 py-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl text-slate-900" style={{ fontFamily: 'Manrope, sans-serif', fontWeight: 700 }}>Closed Leads</h1>
              <p className="text-sm text-slate-600 mt-1" style={{ fontFamily: 'Manrope, sans-serif', fontWeight: 400 }}>Successfully closed deals</p>
            </div>
