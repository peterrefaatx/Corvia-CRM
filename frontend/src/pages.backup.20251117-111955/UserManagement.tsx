...
const UserManagement: React.FC = () => {
  ...
  const getRoleBadgeColor = (role: string) => {
    switch (role) {
      ...
      case 'AccountManager': return 'bg-indigo-100 text-indigo-800';
      case 'TeamLeader': return 'bg-blue-100 text-blue-800';
      case 'SeniorAgent': return 'bg-emerald-700 text-white';
      case 'Agent': return 'bg-green-100 text-green-800';
      case 'QualityControl': return 'bg-orange-100 text-orange-800';
      case 'Client': return 'bg-gray-100 text-gray-800';
      case 'IT': return 'bg-teal-100 text-teal-800';
  ...
  const getRoleLabel = (role: string) => {
    switch (role) {
      ...
      case 'SeniorAgent': return 'Senior Agent';
      case 'Agent': return 'Agent';
      case 'QualityControl': return 'QC Agent';
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {users.map((user) => (
                <tr key={user.id} className={user.isActive ? '' : 'bg-gray-50'}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className={`role-badge inline-flex text-xs font-medium rounded-full px-2 py-1 ${getRoleBadgeColor(user.role)}`}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                    ...
                    {user.managedTeam && (
                      <span className="text-xs text-blue-600 ml-1">(Leads {user.managedTeam.name})</span>
                    )}
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <button
                      ...
                      className={`status-badge inline-flex text-xs font-medium rounded-full px-2 py-1 border ${
                        user.isActive 
        ...
        {showCreateModal && (
          <div className="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm overflow-y-auto h-full w-full z-50 flex items-center justify-center p-4">
            <div className="relative w-full max-w-2xl glass-strong shadow-glass border border-neutral-200/50 overflow-hidden">
              {/* Modal Header */}
              <div className="px-6 py-4 border-b border-neutral-200/50 bg-gradient-to-r from-cyan-50 to-blue-50">
              ...
              <form onSubmit={handleCreateUser} className="p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2.5 border border-neutral-300 focus:ring-2 focus:ring-cyan-500 focus:border-transparent transition-all"
                    />
                  </div>
                ...
                <div className="flex justify-end space-x-3 mt-6 pt-6 border-t border-neutral-200/50">
                  ...
                  <button
                    ...
                    className="px-6 py-2.5 text-sm font-medium text-white bg-cyan-600 hover:bg-cyan-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                  >
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div>
                    ...
                    <input
                      ...
                      className="block w-full px-3 py-2 rounded-lg border border-neutral-200/50 bg-white/80 backdrop-blur-sm shadow-subtle text-neutral-900 focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:border-cyan-400 transition-all"
                    />
                  </div>
                ...
                <div className="flex justify-between items-center pt-6 border-t border-neutral-200/50">
                  ...
                  <div className="flex space-x-3">
                    ...
                    <button
                      ...
                      className="px-5 py-2.5 text-sm font-medium text-white rounded-xl shadow-gentle hover:shadow-hover transition-all bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-600 hover:to-blue-600 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
