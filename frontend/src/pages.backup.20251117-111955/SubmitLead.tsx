            ...
            <div className="grid grid-cols-3 gap-4">
              <div>
                ...
                <select
                  ...
                  className="mt-1 block w-full px-2.5 py-2 rounded-lg border border-neutral-200/50 bg-white/80 backdrop-blur-sm shadow-subtle text-neutral-900 focus:outline-none focus:ring-2 focus:ring-mint-400 focus:border-mint-400 smooth-transition"
                >
                  <option value=""></option>
              ...
              <div>
                ...
                <input
                  ...
                  disabled={isFormDisabled}
                  className="mt-1 block w-full px-2.5 py-2 rounded-lg border border-neutral-200/50 bg-white/80 backdrop-blur-sm shadow-subtle text-neutral-900 focus:outline-none focus:ring-2 focus:ring-mint-400 focus:border-mint-400 smooth-transition disabled:opacity-50 disabled:cursor-not-allowed"
                />
                ...
                <input
                  ...
                  className={`mt-1 block w-full px-2.5 py-2 rounded-lg border bg-white/80 backdrop-blur-sm shadow-subtle focus:outline-none focus:ring-2 smooth-transition disabled:opacity-50 disabled:cursor-not-allowed ${
                    phoneDuplicate 
                      ...
                      : 'border-neutral-200/50 focus:ring-mint-400 focus:border-mint-400 text-neutral-900'
                  }`}
                />
                {errors.phone && (
              ...
              <textarea
                ...
                className={`mt-1 block w-full px-2.5 py-2 rounded-lg border bg-white/80 backdrop-blur-sm shadow-subtle text-neutral-900 focus:outline-none focus:ring-2 smooth-transition disabled:opacity-50 disabled:cursor-not-allowed ${
                  addressDuplicate
                    ...
                    : 'border-neutral-200/50 focus:ring-mint-400 focus:border-mint-400'
                }`}
              />
              {errors.addressText && (
            ...
            <div className="border-t border-neutral-200/50 pt-4">
              <label className="flex items-center">
                <input
                  ...
                  disabled={isFormDisabled}
                  className="rounded border-neutral-300 text-mint-600 focus:ring-mint-400 disabled:opacity-50"
                />
